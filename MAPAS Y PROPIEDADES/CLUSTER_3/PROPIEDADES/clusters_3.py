def clusters_3(doc1,doc2,doc3):
    ...
    fp3_1=open ('3_DISTmin_Ca_Al', 'w')
    fp3_2=open ('3_DISTmed_Ca_Al', 'w')
    fp3_3=open ('3_DISTmin_Si_Al', 'w')
    fp3_4=open ('3_DISTmed_Si_Al', 'w')
    fp3_5=open ('3_DISTmin_Ca_Si', 'w')
    fp3_6=open ('3_DISTmed_Ca_Si', 'w')
    fp3_7=open ('3_COOR_Ca1', 'w')
    fp3_8=open ('3_COOR_Ca2', 'w')
    fp3_9=open ('3_COOR_Ca3', 'w')
    fp3_10=open ('3_COOR_Ca4', 'w')
    fp3_11=open ('3_COORmed_Ca', 'w')
    fp3_12=open ('3_COOR_Al', 'w')
    fp3_13=open ('3_COOR_Si1', 'w')
    fp3_14=open ('3_COOR_Si2', 'w')
    fp3_15=open ('3_COOR_Si3', 'w')
    fp3_16=open ('3_COORmed_Si', 'w')
    fp3_17=open ('3_H2O', 'w')
    fp3_18=open ('3_ENLACES_Ca-O-Al', 'w')
    fp3_19=open ('3_ENLACES_Ca-O-H-Al', 'w')
    fp3_20=open ('3_ENLACES_Si-O-Si', 'w')
    fp3_21=open ('3_ENLACES_Si-O-Al', 'w')
    ...
    for i in range (num_struc):
        ...
        #Distancias Si-Al
        d_Si1_Al=dist('Si','Al',POSCAR,atom1_aux=0)
        d_Si2_Al=dist('Si','Al',POSCAR,atom1_aux=1)
        d_Si3_Al=dist('Si','Al',POSCAR,atom1_aux=2)

        #Distancia min Si-Al
        d_min_Si_Al=min(d_Si1_Al,d_Si2_Al,d_Si3_Al)
        fp3.write('Distancia min Si-Al:'+str(d_min_Si_Al)+'\n')

        fp3_3.write(str(d_min_Si_Al)+'\n')

        #Distancia media Si-Al
        d_med_Si_Al=(d_Si1_Al+d_Si2_Al+d_Si3_Al)/3
        ...
        d_Ca1_Si3=dist('Ca','Si',POSCAR,atom1_aux=0,atom2_aux=2)
        d_Ca2_Si3=dist('Ca','Si',POSCAR,atom1_aux=1,atom2_aux=2)
        d_Ca3_Si3=dist('Ca','Si',POSCAR,atom1_aux=2,atom2_aux=2)
        d_Ca4_Si3=dist('Ca','Si',POSCAR,atom1_aux=3,atom2_aux=2)

        d_min_Ca_Si3=min(d_Ca1_Si3,d_Ca2_Si3,d_Ca3_Si3,d_Ca4_Si3)
        d_med_Ca_Si3=(d_Ca1_Si3+d_Ca2_Si3+d_Ca3_Si3+d_Ca4_Si3)/4
        
        #Distancia min Ca-Si
        d_min_Ca_Si=min(d_min_Ca_Si1,d_min_Ca_Si2,d_min_Ca_Si3)
        ...
        d_media_Ca_Si=(d_med_Ca_Si1+d_med_Ca_Si2+d_med_Ca_Si3)/3
        ...
        coor_Si3=num_coor('Si','O',POSCAR,cutoff_Ca,atom1_aux=2)

        fp3.write('Coordinación Si1 (cutoff='+str(cutoff_Si)+'):'+str(coor_Si1)+'\n')
        fp3.write('Coordinación Si2 (cutoff='+str(cutoff_Si)+'):'+str(coor_Si2)+'\n')
        fp3.write('Coordinación Si3 (cutoff='+str(cutoff_Si)+'):'+str(coor_Si3)+'\n')
        fp3.write('Coordinación media Si (cutoff='+str(cutoff_Si)+'):'\
                  +str((coor_Si1+coor_Si2+coor_Si3)/3)+'\n')

        fp3_13.write(str(coor_Si1)+'\n')
        fp3_14.write(str(coor_Si2)+'\n')
        fp3_15.write(str(coor_Si3)+'\n')
        fp3_16.write(str((coor_Si1+coor_Si2+coor_Si3)/3)+'\n')
        
        #Número de moléculas de H2O
        H2O=num_agua(POSCAR)
        fp3.write('Número de moléculas de H2O:'+str(H2O)+'\n')
        
        fp3_17.write(str(H2O)+'\n')
        ...
        fp3_18.write(str(enlaces_Ca_O_Al)+'\n')
        ...
        fp3_19.write(str(enlaces_Ca_O_H_Al)+'\n')
        ...
        fp3_20.write(str(enlaces_Si_O_Si)+'\n')
        ...
        fp3_21.write(str(enlaces_Al_O_Si)+'\n')
