def clusters_1(doc1,doc2,doc3):
    ...
    #En un nuevo archivo 1_ENERGIA_NORM, se escriben las energías
    #de 1_ENERGIA, pero normalizadas

    fp=open ('1_ENERGIA_NORM', 'w')
    ...
    fp3_1=open ('1_DIST_Ca_Al', 'w')
    fp3_2=open ('1_COOR_Ca', 'w')
    fp3_3=open ('1_COOR_Al', 'w')
    fp3_4=open ('1_H2O', 'w')
    fp3_5=open ('1_ENLACES_Ca-O-Al', 'w')
    fp3_6=open ('1_ENLACES_Ca-O-H-Al', 'w')
    ...
    for i in range (num_struc):
        ...
        #Distancia Ca-Al
        d_Ca_Al=dist('Ca','Al',POSCAR)
        fp3.write('Distancia Ca-Al:'+str(d_Ca_Al)+'\n')
        
        fp3_1.write(str(d_Ca_Al)+'\n')       

        #Número de coordinación del Ca (Con O)
        cutoff_Ca=2.83062
        coor_Ca=num_coor('Ca','O',POSCAR,cutoff_Ca)
        fp3.write('Coordinación Ca (cutoff='+str(cutoff_Ca)+'):'+str(coor_Ca)+'\n')
        
        fp3_2.write(str(coor_Ca)+'\n')
        ...
        fp3_5.write(str(enlaces_Ca_O_Al)+'\n')
        ...
        fp3_6.write(str(enlaces_Ca_O_H_Al)+'\n')
